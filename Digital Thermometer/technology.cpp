...
void technology::readSerial()
{
    ...
    if(buffer_split.length() < 3){
        ...
        technology::updateTemperature(parsed_data);
    }

}

void technology::updateTemperature(QString sensor_reading)
{
    //  update the value displayed on the lcdNumber
    ui->temp->setText(sensor_reading+" Degree Fahrenheit");
}
